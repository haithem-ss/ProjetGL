import { Text, Flex, Image, Button,Badge,FormControl,FormLabel,Input,useToast ,FormHelperText,Radio,Link,Show} from "@chakra-ui/react";
...
export default function SignUp(){
  ...
  const navigate = useNavigate();
      ...
      const handleSubmit = async (e) => {
        e.preventDefault();
        UseRegister(UserInfos,toast,navigate)
      };
    ...
    return(
        <Flex w='100vw' h='100vh'justifyContent={['center','center','space-between']} bgSize='contain' gap={ {md:'0',xl:'10'} } bgPosition='center'  bgImage={image} bgColor='#1A1B1C;' overflow='hidden'>
            ...
            <Flex flexDirection='column' w={['90%','md']} mx={{md:'40'}}  my='auto' alignItems='center' gap='10' order='1' height="99%">
                <Image src={logo} w='40'></Image>
                <Flex flexDirection='column' w={['full','full','xl','xl']} h={{md:'xl'}} gap='3' justifyContent='center' alignItems='center' bgColor='white' borderRadius='4px' p='10' paddingTop="0"  paddingBottom="0" maxWidth='100%' >
                    ...
                    <Button borderRadius='0px' bgColor='#00F07D' width='100%' type='submit' onClick={handleSubmit}><Text fontSize='lg' color='black'>Register</Text></Button>
