...
const ProductPage = () => {
  ...
  }, [commune, module, lieu, wilaya, category]);
  ...
  const dataSumbit = async (e) => {
    ...
    const auteur_id = 1;
    const payload = `niveau=${category}&modalité=${modalite}&description=${description}&titre=your way to learn ${moduleName}&tarif=${price}&tarifPromotion=${tarifPromotion}&lieuFormation=${
      lieu.id ? lieu.id : 1
    }&module=${module.id}&auteur=${auteur_id}&thumnail_url=${thumbnail_url}`;
